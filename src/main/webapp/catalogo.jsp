...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    ...
    <div class="collapse navbar-collapse">
        <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
                <a class="nav-link" href="verCarrito.jsp">Carrito de Compras</a> <!-- Enlace al carrito -->
            </li>
        </ul>
    </div>
</nav>
        ...
        <div class="col-md-4">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <a href="CarritoServlet?action=add&id=<%= producto.getId() %>" class="btn btn-success">Agregar al Carrito</a> <!-- Agregar al carrito -->
                </div>
            </div>
        </div>
        <% 
